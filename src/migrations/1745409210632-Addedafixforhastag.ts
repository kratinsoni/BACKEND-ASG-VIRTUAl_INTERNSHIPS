...
export class Addedafixforhastag1745409210632 implements MigrationInterface {
    name = 'Addedafixforhastag1745409210632'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "posts" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar(255) NOT NULL, "content" text NOT NULL, "hashTags" json NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "autherId" integer, CONSTRAINT "FK_8af424a0959fa196e03d4fa7a48" FOREIGN KEY ("autherId") REFERENCES "users" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
